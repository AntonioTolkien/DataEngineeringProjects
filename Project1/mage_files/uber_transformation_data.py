...
def transform(df, *args, **kwargs):
    ...
    rate_code_dim['rate_code_name'] = rate_code_dim['RatecodeID'].replace(RCID_dict)
    ...
    payment_type_dim['payment_type_name'] = payment_type_dim['payment_type'].replace(PT_dict)
